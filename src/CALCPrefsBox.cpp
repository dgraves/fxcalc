...
: FXDialogBox(owner,"Calculator Preferences",DECOR_TITLE|DECOR_BORDER|DECOR_CLOSE|DECOR_MENU|DECOR_RESIZE,0,0,400,0, 0,0,0,0)
{
  ...
  FXMatrix *matrix1=new FXMatrix(settingsframe,3,MATRIX_BY_COLUMNS|PACK_UNIFORM_HEIGHT|LAYOUT_FILL_X|LAYOUT_FILL_Y);
  ...
  new FXButton(matrix1,"Default",NULL,owner,CALCWindow::ID_DEFAULTDISPLAYFONT,FRAME_RAISED|FRAME_THICK|LAYOUT_RIGHT|LAYOUT_CENTER_Y|LAYOUT_FILL_COLUMN|LAYOUT_FILL_ROW);
  ...
  new FXButton(matrix1,"Default",NULL,owner,CALCWindow::ID_DEFAULTBUTTONFONT,FRAME_RAISED|FRAME_THICK|LAYOUT_RIGHT|LAYOUT_CENTER_Y|LAYOUT_FILL_COLUMN|LAYOUT_FILL_ROW);
  ...
  new FXButton(matrix1,"Default",NULL,owner,CALCWindow::ID_DEFAULTMODE,FRAME_RAISED|FRAME_THICK|LAYOUT_RIGHT|LAYOUT_CENTER_Y|LAYOUT_FILL_COLUMN|LAYOUT_FILL_ROW);
  ...
  new FXButton(matrix1,"Default",NULL,owner,CALCWindow::ID_DEFAULTWIDTH,FRAME_RAISED|FRAME_THICK|LAYOUT_RIGHT|LAYOUT_CENTER_Y|LAYOUT_FILL_COLUMN|LAYOUT_FILL_ROW);
  ...
  new FXButton(matrix1,"Default",NULL,owner,CALCWindow::ID_DEFAULTHEIGHT,FRAME_RAISED|FRAME_THICK|LAYOUT_RIGHT|LAYOUT_CENTER_Y|LAYOUT_FILL_COLUMN|LAYOUT_FILL_ROW);
  ...
  new FXButton(matrix1,"Default",NULL,owner,CALCWindow::ID_DEFAULTNUMDIGITS,FRAME_RAISED|FRAME_THICK|LAYOUT_RIGHT|LAYOUT_CENTER_Y|LAYOUT_FILL_COLUMN|LAYOUT_FILL_ROW);
